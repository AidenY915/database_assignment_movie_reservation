...
public class MovieDetailPanel extends MovieReservationPanel {
    ...
    private BookingDTO bookingToEdit; // 추가
    ...
    public void setBookingToEdit(BookingDTO bookingToEdit) { // 추가
    ...
    public void init() {
        ...
        JButton moveToReservationBtn = new MoveToReservationBtn(movieDTO, bookingToEdit); // 수정
...
class MoveToReservationBtn extends JButton {
    ...
    public MoveToReservationBtn(MovieDTO movieDTO, BookingDTO bookingToEdit) { // 수정
        super("예매하기");
        this.movieDTO = movieDTO;
        this.bookingToEdit = bookingToEdit; // 추가
    ...
    class MoveToReservationActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            reservationPanel.setSelectedMovie(movieDTO);
            if (bookingToEdit != null) {
                reservationPanel.setEditMode(bookingToEdit, false); // 예약 정보 전달
            }
